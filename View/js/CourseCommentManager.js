...
formData.append("getAllCourses", "")
getAllCourses(formData)
...
function getAllCourses(formData){
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                  <div class="card bg-dark">
                    ...
                    <div class="card-body">
                      ...
                      <a href="/LearnDome/View/html/admins/comments.html" class="btn btn-danger" id="${course.id}" onclick="setSelectedCourseId(this.id)">Ver comentarios</a>
                    </div>
                  </div>
                </div>
                `
